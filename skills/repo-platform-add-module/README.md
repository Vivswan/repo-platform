...
- Carries the per-module companion checklist: central settings labels, the bun module's Dependabot secret, pages one-time setup, listing skills in the repo-owned plugin manifest
