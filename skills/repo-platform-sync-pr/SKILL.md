...
- `<what> sits at the path, and the writer will not replace it`: a directory, or something that is neither a regular file nor a link, stands where a managed, split, or starter entry is declared
