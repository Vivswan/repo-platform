...
const GENERATOR_MENTIONS: [string, string][] = [
  [
    "a helper naming the generator that calls it (jinja_subset.ts)",
  ...
  [
    "a loader naming the regions derived from it (module_manifests.ts)",
    "// Shared loader for the module manifests (templates/<module>/module.yml).\n//\n// scripts/generate.ts derives the marker-fenced GENERATED regions from\n// these; scripts/compose/compose.ts reads them at runtime.\n",
  ],
  [
    "an oracle naming the renderer it checks (verify_dogfood_oracle.ts)",
    "// TS renderer behind `bun run dogfood` (scripts/generate/render_dogfood.ts +\n// scripts/lib/jinja_subset.ts) agrees with what real copier produces\n",
  ],
  [
    "a roster whose tables are generated regions (validator/ownership.ts)",
    "// The four tables are generated from the\n// module manifests and templates/base/ownership.yml (scripts/generate.ts);\n",
  ],
];
...
describe("isGenerated / isManaged", () => {
  test.each<[string, string, boolean, boolean]>([
    ...
    [
      "the gitignore generator's whole-file marker",
      "{# Generated by scripts/generate/build_gitignore.ts - edit the script, not this file. #}\nx\n",
      true,
      false,
    ],
    [
      "the composed ownership manifest's marker",
      "# Generated by {{ github_username }}/repo-platform - do not edit. Every path\nx\n",
      true,
      false,
    ],
    [
