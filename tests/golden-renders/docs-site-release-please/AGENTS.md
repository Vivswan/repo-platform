...
- PR titles and commit subjects are Conventional Commits; they drive release-please versioning. PRs are squash-merged, so the PR title becomes the commit subject.
