...
13. [Security scans](security-scans.md) - Trivy fleet-wide: the blocking fixable HIGH-or-CRITICAL gate, the expiring bypass file, and the nightly scan that files one tracking issue per repository; semgrep on public repositories.
