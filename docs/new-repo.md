...
- Nothing in the repository applies its settings: repo-platform's central run does, nightly and after a green push there that changes settings inputs or syncs the fleet.
