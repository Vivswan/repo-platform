...
- VitePress `<!-- @include: file.md -->` directives work, but a page that uses one lists no heading rows in the launcher's page index; full-text search still reaches those headings.
