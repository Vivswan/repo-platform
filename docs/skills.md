...
- the `validate-skills` composite action in this repository (`actions/validate-skills`), pinned at the green-gated `build` delivery branch like every other managed action
