...
- **Images:** an image in the article opens in a lightbox on click, at its natural size up to the viewport; Escape, a click, or a scroll closes it. A linked image stays a link.
