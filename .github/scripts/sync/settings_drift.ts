...
// the render on purpose (SECURITY.md, the CodeQL jobs, and settings.yml
// must follow the repo's real state), so a value changed out-of-band in
// the GitHub UI would ride a clean sync PR into the rendered files and
